...
public class SQLiteDatabaseHandler extends SQLiteOpenHelper {
    ...
    public void updateNote(Note note) {
        ...
        contentValues.put(NOTE_NAME, note.getTaskName());
        contentValues.put(DESCRIPTION, note.getTaskDescription());

        db.update(TABLE_NOTE, contentValues, NOTE_NAME + " = ?", new String[]{note.getTaskName()});
        db.update(TABLE_NOTE, contentValues, DESCRIPTION + " = ?", new String[]{note.getTaskDescription()});
    }
